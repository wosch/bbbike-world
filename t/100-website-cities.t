...
sub _cities {
    ...
    like( $content, qr{Content-Type" content="text/html; charset=utf-8"|content="text/html; charset=utf-8" http-equiv="Content-Type"}, "charset" );
    like( $content, qr|rel="shortcut|, "icon" );
    like( $content, qr{type="application/opensearchdescription\+xml" .*href="/osp/\S+\.xml"|href="/osp/\S+\.xml" .*type="application/opensearchdescription\+xml"} , "opensearch" );
    like( $content, qr{type="application/atom\+xml" .*href="/feed/bbbike-world.xml| href="/feed/bbbike-world.xml" .*type="application/atom\+xml"}, "rss");
