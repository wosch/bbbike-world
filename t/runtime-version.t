...
my $versions = {
    'debian6' => [
        ...
        [
            [qw/java -version/],
            qr/^(openjdk|java) version "17\.0\.[236]|11.0.(1[16|18|45])/m
        ],
        [
            [qw/java -version/],
        ...
        [
            [qw/perltidy -v/],
qr/^This is perltidy, (v20090616|v20101217|v20140328|v20120701|v20170521|v20180220|v20190601|v20200110|v20210717)/
        ],
    ]
};
