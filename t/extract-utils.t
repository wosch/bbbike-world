...
is( is_lat(0),      1, "lat 50" );
is( is_lat(50),     1, "lat 50" );
is( is_lat(-50),    1, "lat -50" );
is( is_lat(90),     1, "lat 90" );
is( is_lat(-90),    1, "lat -90" );
is( is_lat(150),    0, "not lat 150" );
is( is_lat(-150),   0, "not lat -150" );
is( is_lat(179),    0, "not lat 179" );
is( is_lat(-179),   0, "not lat -179" );
is( is_lat(10150),  0, "not lat 10150" );
is( is_lat(-10150), 0, "not lat -10150" );

diag("is_lng()") if $debug;
is( is_lng(0),      1, "lng 50" );
is( is_lng(50),     1, "lng 50" );
is( is_lng(-50),    1, "lng -50" );
is( is_lng(150),    1, "not lng 150" );
is( is_lng(-150),   1, "not lng -150" );
is( is_lng(179),    1, "not lng 179" );
is( is_lng(-179),   1, "not lng -179" );
is( is_lng(180),    1, "not lng 180" );
is( is_lng(-180),   1, "not lng -180" );
is( is_lng(181),    0, "not lng 181" );
is( is_lng(-181),   0, "not lng -181" );
is( is_lng(10150),  0, "not lng 10150" );
is( is_lng(-10150), 0, "not lng -10150" );
