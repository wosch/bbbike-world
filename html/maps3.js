...
var state = {
    ...
    non_map_tags: ["copyright", "weather_forecast_html", "top_right", "other_cities", "footer", "routing", "route_table", "routelist", "link_list", "bbbike_graphic", "chart_div", "routes", "headlogo", "bottom", "language_switch", "headline", "sidebar", "sidebar_dummy"],
...
/* XXX: danger!
	...
	*/
    ...
    var cycle_options = {
        ...
        getTileUrl: function (a, z) {
            return "https://" + randomServerOSM() + ".tile.thunderforest.com/cycle/" + z + "/" + a.x + "/" + a.y + ".png?apikey=6170aad10dfd42a38d4d8c709a536f38";
        },
        isPng: true,
        opacity: 1.0,
        tileSize: new google.maps.Size(256, 256),
    ...
    var ocm_transport_options = {
        ...
        getTileUrl: function (a, z) {
            return "https://" + randomServerOSM() + ".tile.thunderforest.com/transport/" + z + "/" + a.x + "/" + a.y + ".png?apikey=6170aad10dfd42a38d4d8c709a536f38";
        },
        isPng: true,
        opacity: 1.0,
        tileSize: new google.maps.Size(256, 256),
    ...
    var ocm_landscape_options = {
        ...
        getTileUrl: function (a, z) {
            return "https://" + randomServerOSM() + ".tile.thunderforest.com/landscape/" + z + "/" + a.x + "/" + a.y + ".png?apikey=6170aad10dfd42a38d4d8c709a536f38";
        },
        isPng: true,
        opacity: 1.0,
        tileSize: new google.maps.Size(256, 256),
